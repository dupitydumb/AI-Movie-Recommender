...
export default function DeveloperPage() {
  ...
  const handleGenerateKey = async () => {
    ...
    try {
      // Use the test token generation endpoint
                ...
                {!generatedKey ? (
                  <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <div className="flex items-center gap-3 p-4 bg-gray-800/30 rounded-xl">
                        ...
                        <div>
                          <div className="font-semibold text-white">3 Hour Validity</div>
                      ...
                      <div className="flex items-center gap-3 p-4 bg-gray-800/30 rounded-xl">
                        ...
                        <div>
                          <div className="font-semibold text-white">100 Requests</div>
                          <div className="text-sm text-gray-400">Rate limit included</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 p-4 bg-gray-800/30 rounded-xl">
                    ...
                    <DialogRoot 
                      ...
                      onOpenChange={(details) => setShowWarningDialog(details.open)}
                    >
                      <DialogTrigger asChild>
                        <Button
                          size="lg"
                          disabled={isGenerating}
                          className="px-8 py-4 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition-all duration-200 hover:scale-105 focus:ring-2 focus:ring-blue-500/50 min-w-[200px]"
                        >
                          {isGenerating ? (
                      ...
                      <DialogContent className="bg-gray-900 border border-gray-700">
                        <DialogHeader>
                          <DialogTitle className="flex items-center gap-2 text-yellow-400">
                            ...
                            Test JWT Token - Important Notice
                          </DialogTitle>
                        </DialogHeader>
                        <DialogBody className="space-y-4">
                          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
                            <h4 className="font-semibold text-yellow-400 mb-2">Testing Purpose Only</h4>
                            <p className="text-gray-300 text-sm">
                              This JWT token is intended for testing and development purposes only.
                            </p>
                          </div>
                          ...
                          <div className="space-y-3 text-sm text-gray-300">
                            <div className="flex items-center gap-2">
                              ...
                              <span>Token expires in <strong className="text-white">3 hours</strong></span>
                            </div>
                            <div className="flex items-center gap-2">
                              <Zap className="w-4 h-4 text-green-400" />
                              <span>Limited to <strong className="text-white">100 requests</strong> total</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <Shield className="w-4 h-4 text-purple-400" />
                              <span>Access to all API endpoints for testing</span>
                            </div>
                          </div>

                          <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
                            <h4 className="font-semibold text-red-400 mb-2">Production Usage</h4>
                            <p className="text-gray-300 text-sm">
                              For production applications, please obtain a proper API key from our{" "}
                              <Button
                                variant="plain"
                                size="sm"
                                onClick={() => window.open('https://rapidapi.com/AirFU/api/ai-movie-recommender', '_blank')}
                  ...
                  >
                    ...
                    <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6 text-center">
                      ...
                      <h3 className="text-2xl font-bold text-white mb-2">JWT Token Generated Successfully!</h3>
                      <p className="text-gray-300">Your test token is ready for development use.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gray-900/50 border border-gray-800 rounded-xl overflow-hidden">
                        <div className="p-4 border-b border-gray-800">
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              size="sm"
                              variant="ghost"
                              onClick={() => copyToClipboard(generatedKey.accessToken, 'Access Token')}
                        ...
                        <div className="p-4">
                          <Code className="text-xs text-gray-300 bg-gray-800 p-3 rounded-lg font-mono break-all">
                            {generatedKey.accessToken}
                          </Code>
                        </div>
                      </div>
                        ...
                        <div className="p-4 border-b border-gray-800">
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              size="sm"
                              variant="ghost"
                              onClick={() => copyToClipboard(generatedKey.refreshToken, 'Refresh Token')}
                              className="text-gray-400 hover:text-white"
                            >
                    ...
                    <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <div className="font-mono text-white">{generatedKey.user?.id || generatedKey.user?.userId || 'N/A'}</div>
                        </div>
                        <div>
                          <div className="text-gray-400">Plan</div>
                          <div className="font-mono text-white capitalize">{generatedKey.user?.plan || 'Test User'}</div>
                        </div>
                        <div>
                          <div className="text-gray-400">Rate Limit</div>
                          <div className="font-mono text-white">{generatedKey.requestLimit || generatedKey.user?.rateLimit?.requests || 100} requests</div>
                        </div>
                        <div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-400 text-lg mb-8">
                  Explore our comprehensive API documentation and start building amazing movie experiences.
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-gray-600 text-gray-300 hover:bg-gray-800 px-6 py-3 rounded-xl cursor-pointer"
                  >
                    Quick Start Guide
                  </Button>
                </div>
                ...
                {[
                  {
                    ...
                    title: "RESTful API",
                    description: "Clean, intuitive endpoints that follow REST conventions for easy integration."
                  },
                  {
                  ...
                  },
                  {
                    ...
                    description: "JWT authentication, rate limiting, and 99.9% uptime guarantee."
                  }
                ].map((feature, index) => (
                  <motion.div
                    key={feature.title}
                    ...
                    viewport={{ once: true }}
                    className="p-6 bg-gray-900/30 rounded-2xl border border-gray-800/50 hover:border-gray-700/50 transition-all duration-300"
                  >
